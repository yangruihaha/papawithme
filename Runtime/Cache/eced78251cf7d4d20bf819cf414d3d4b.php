			...
			<div class="span6">
				<form class="form-horizontal" id="profile_form" enctype="multipart/form-data" method="post" action="<?php echo ($appdir); ?>/index.php/Home/updateProfile">
					<div class="control-group">
						...
						<div class="controls">
							<input name="profile_name" id="profile_name" value="<?php echo ($profile['profile_name']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="profile_motto" id="profile_motto" value="<?php echo ($profile['profile_motto']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_head">头像</label>
						<div class="controls">
							<input name="profile_head" id="profile_head" value="<?php echo ($profile['profile_head']); ?>" type="file" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_skill">技能</label>
						<div class="controls">
							<input name="profile_skill" id="profile_skill" value="<?php echo ($profile['profile_skill']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_hobby">爱好</label>
						<div class="controls">
							<input name="profile_hobby" id="profile_hobby" value="<?php echo ($profile['profile_hobby']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_now">感情状态</label>
						<div class="controls">
							<input name="profile_now" id="profile_now" value="<?php echo ($profile['profile_now']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_department">院系</label>
						<div class="controls">
							<input name="profile_department" id="profile_department" value="<?php echo ($profile['profile_department']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_birthday">生日</label>
						<div class="controls">
							<input name="profile_birthday" id="profile_birthday" value="<?php echo ($profile['profile_birthday']); ?>" type="text" onfocus="HS_setDate(this)" />
						</div>
					</div>
					<div class="control-group">
						 <label class="control-label" for="profile_autobiography">自我评价</label>
						<div class="controls">
							<input name="profile_autobiography" id="profile_autobiography" value="<?php echo ($profile['profile_autobiography']); ?>" type="text" />
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
